...
echo ""
echo -e "${YELLOW}Advanced Configuration Options:${NC}"
echo "The template now includes capacity block support and advanced options:"
echo "- Capacity Blocks: Uncomment CapacityReservationTarget sections"
echo "- Spot Instances: Uncomment SpotPrice settings for cost optimization"
echo "- EFA Support: Uncomment Efa sections for high-performance networking"
echo "- Custom Actions: Uncomment CustomActions for lifecycle events"
echo "- Login Nodes: Uncomment LoginNodes for interactive access"
echo ""
echo -e "${CYAN}📖 See CAPACITY_BLOCK_GUIDE.md for detailed configuration instructions${NC}"
